...
#convert to numeric 
epwdata$Global_active_power<- as.numeric(epwdata$Global_active_power)
#defining png output
png(filename = "./Plot3.png", width=480, height=480)
#plot the histogram
hist(epwdata$Global_active_power, breaks= 16, col= "red", xlab = "Global active power (kilowatts)", main = "Global active power")
#housekeeping
dev.off()
